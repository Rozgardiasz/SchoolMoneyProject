<template>
    <div class="p-6 min-h-screen">
      ...
      <!-- Sekcja z dwiema kolumnami: Aktywne zbiórki i Członkowie klasy -->
      <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
        <!-- Członkowie klasy: zajmuje 2/5 szerokości -->
        <div
          class="bg-white p-4 rounded-lg shadow-md col-span-2"
          :style="{ height: `${members.length * 88}px` }"
        >
          <h2 class="text-xl font-semibold mb-4">Członkowie klasy</h2>
          <ul class="space-y-3">
            <li
        ...
        <div
          ...
          :style="{ height: `${filteredCollections.length * 160}px` }"
        >
        ...
        collections: [
          {
            ...
            image: 'https://www.investopedia.com/thmb/u220LqqeStsaBPgVITIKYKTMOic=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-200275642-001-576a033e5f9b58346aace876.jpg',
          },
          {
            id: 2,
            name: 'Zbiórka 2',
